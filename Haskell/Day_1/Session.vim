...
nnoremap <silent> <Plug>(dotoo-agenda-headline-clock-stop) :call dotoo#agenda#stop_headline_clock()
nnoremap <silent> <Plug>(dotoo-agenda-headline-clock-start) :call dotoo#agenda#start_headline_clock()
nnoremap <silent> <Plug>(dotoo-agenda-headline-undo-change) :call dotoo#agenda#undo_headline_change()
nnoremap <silent> <Plug>(dotoo-agenda-headline-change-todo) :call dotoo#agenda#change_headline_todo()
nnoremap <silent> <Plug>(dotoo-agenda-headline-move) :call dotoo#agenda#move_headline()
nnoremap <silent> <Plug>(dotoo-agenda-save-files) :call dotoo#agenda#save_files()
nnoremap <silent> <Plug>(dotoo-agenda-refresh) :call dotoo#agenda#refresh_view()
nnoremap <silent> <Plug>(dotoo-headline-change-todo) :call dotoo#change_todo()
nnoremap <silent> <Plug>(dotoo-headline-move-menu) :call dotoo#move_headline_menu(dotoo#get_headline())
nnoremap <silent> <Plug>(dotoo-clock-stop) :call dotoo#clock#stop()
nnoremap <silent> <Plug>(dotoo-clock-start) :call dotoo#clock#start()
nnoremap <silent> <Plug>(dotoo-checkbox-toggle) :call dotoo#checkbox#toggle()
nnoremap <silent> <Plug>(dotoo-date-normalize) :call dotoo#date#normalize()
nnoremap <silent> <Plug>(dotoo-date-decrement) :call dotoo#date#decrement(v:count1)
nnoremap <silent> <Plug>(dotoo-date-increment) :call dotoo#date#increment(v:count1)
nnoremap <silent> <Plug>(dotoo-link-back) :call dotoo#link#back()
nnoremap <silent> <Plug>(dotoo-link-follow) :call dotoo#link#follow('edit')
nnoremap <silent> <Plug>(dotoo-capture) :call dotoo#capture#capture()
nnoremap <silent> <Plug>(dotoo-agenda) :call dotoo#agenda#agenda()
...
set ruler
set runtimepath=~/.vim,~/.vim/plugged/vim-airline,~/.vim/plugged/goyo.vim,~/.vim/plugged/limelight.vim,~/.vim/plugged/numbers.vim,~/.vim/plugged/vim-monokai-tasty,~/.vim/plugged/vim-fugitive,~/.vim/plugged/vim-table-mode,~/.fzf,~/.vim/plugged/fzf.vim,~/.vim/plugged/vim-dotoo,/usr/share/vim/site,/usr/share/vim/vim90,/usr/share/vim/vim90/pack/dist/opt/matchit,/usr/share/vim/site/after,~/.vim/after
set shiftwidth=4
set showcmd
set showmatch
set spelllang=hu
...
silent only
silent tabonly
cd ~/Projects/Programming/Advent_of_Code_2023/Haskell/Day_1
...
badd +10 Main.hs
badd +995 ~/Projects/Programming/Advent_of_Code_2023/input_1.txt
badd +31 ~/Dokumentumok/Sugárvédelmi_tanfolyam/írásbeli.md
argglobal
%argdel
$argadd Main.hs
edit Main.hs
...
argglobal
balt ~/Dokumentumok/Sugárvédelmi_tanfolyam/írásbeli.md
setlocal keymap=
setlocal noarabic
...
let s:l = 14 - ((11 * winheight(0) + 7) / 15)
...
wincmd w
argglobal
if bufexists(fnamemodify("~/Projects/Programming/Advent_of_Code_2023/input_1.txt", ":p")) | buffer ~/Projects/Programming/Advent_of_Code_2023/input_1.txt | else | edit ~/Projects/Programming/Advent_of_Code_2023/input_1.txt | endif
balt Main.hs
setlocal keymap=
setlocal noarabic
setlocal noautoindent
